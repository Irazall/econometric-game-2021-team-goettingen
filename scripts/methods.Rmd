...
\[
\eta_{it} = \beta_0 + \beta_1 wtype_{it}  + \beta_2 construction\_period_{it} + \beta_3 garden_{it} + \\
...
# Esimtation Results
The following plots show the regression table as well as the qq-plot, histogramm of the residuals. The model was compared to that 
