...
```{r descriptive anaasdasdsadlysis, child = 'descriptive_analysis.Rmd'}
...
```{r descriptive analyasdasdasdsis, child = 'descriptive_analysis.Rmd'}
par(mfrow=c(1,2))
...
```{r descriptive analadasdasdysis, child = 'descriptive_analysis.Rmd'}
